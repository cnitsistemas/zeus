...
export default function PrivacityPolitic() {
  return (
    <>
      <Container
        maxWidth="md"
      ...
      >
        ...
        <p>
          <span style={{ color: "rgb(68, 68, 68);" }}>
            A sua privacidade é importante para nós. É política do Tecnogatt
            respeitar a sua privacidade em relação a qualquer informação sua que
            possamos coletar no site{" "}
            <a href="https://cnitsistemas.com.br/">CNIT</a>, e outros sites que
        ...
        <p>
          <span style={{ color: "rgb(68, 68, 68);" }}>
            ...
            informação que o CNIT oferece no site e com caráter enunciativo, mas
            não limitativo:
          </span>
        </p>
        <ul>
          ...
          <li>
            <span style={{ color: "rgb(68, 68, 68);" }}>
              ...
              (softwares) do CNIT, de seus fornecedores ou terceiros, para
        ...
        <p>
          <span style={{ color: "rgb(68, 68, 68);" }}>
            Esta política é efetiva a partir de&nbsp;26 April 2023 19:14
          </span>
        </p>
      </Container>
    </>
