...
export default function Account({ open, userName, userEmail, avatar }:
  { open: boolean, userName: string, userEmail: string, avatar: string }) {
  ...
  return <Box sx={{
    ...
    <AccountBox>
      ...
      <IconButton sx={{
        ml: 1, fontSize: '16px', color: "#C63D2F"
